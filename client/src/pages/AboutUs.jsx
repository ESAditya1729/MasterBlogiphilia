    ...
    <div className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white">
      ...
      <section className="relative max-w-7xl mx-auto px-4 py-28 md:py-36 text-center">
        ...
        >
          ...
          >
            <div className="absolute -left-6 top-0 text-5xl text-emerald-400/30 dark:text-emerald-500/30">
              “
            </div>
            ...
            <div className="absolute -right-6 bottom-0 text-5xl text-emerald-400/30 dark:text-emerald-500/30">
              ”
            </div>
          ...
          >
            Empowering the voices of tomorrow through words today. Blogiphilia
            is where passion meets expression.
          </motion.p>
            ...
            <div className="relative z-10">
              ...
              >
                ...
                <div className="relative bg-white dark:bg-slate-800 p-8 rounded-xl shadow-lg border border-slate-100 dark:border-slate-700">
                  ...
                  >
                    {`Blogiphilia is not just a platform,`
                      .split(" ")
                      .map((word, i) => (
                        <motion.span
                          key={i}
                    ...
                    {`it's a movement rooted in the belief that words shape worlds.`
                      .split(" ")
                      .map((word, i) => (
                        <motion.span
                          key={i + 10}
                    ...
                    {`Inspired by this vision, we're building a vibrant ecosystem where authentic voices flourish.`
                      .split(" ")
                      .map((word, i) => (
                        <motion.span
                          key={i + 20}
