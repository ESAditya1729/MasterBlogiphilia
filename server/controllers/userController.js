...
// @desc    Set profile picture to selected avatar
...
export const setAvatar = async (req, res, next) => {
  try {
    ...
    // Optionally: validate that avatarUrl is from your allowed list
    ...
    if (!allowedAvatars.includes(avatarUrl)) {
      return res.status(400).json({ success: false, error: 'Invalid avatar selected' });
    }
